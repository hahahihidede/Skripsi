...
if __name__== "__main__":
    ...
    while cap.isOpened():
            ...
            for j in position.keys():
                if i < j:
                    ...
                    if distanceOfboundBoxes < 150: # jarak tidak aman
                        ...
                        # print(round (distanceOfboundBoxes,1), "cm")
        ...
        # cv2.putText(frame, "JARAK : " + str(distanceOfboundBoxes) , (250,90), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (253, 215, 3), 2)
